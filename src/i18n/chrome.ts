export const CHROME = {
  en: {
    ...
    copyTemplate: "Copy template", pasteTemplate: "Paste template",
    copyTemplateTitle: "Copy this form as a template you can paste into another builder",
    pasteTemplateTitle: "Replace this form with the copied template",
    pasteTemplateConfirm: "Replace the current form with the copied template? This can't be undone.",
    noTemplates: "No templates saved yet. Click \"Save\" in the toolbar to store this form here.",
    noTemplatesReadonly: "No templates available yet.",
    updated: "Updated", open: "Open", applyTemplate: "Apply", saveForm: "Save as template", formName: "Template name",
    saveToLibrary: "Save template", loadingDraft: "Loading your draft...",
    templatesLimitReached: (max: number) => `You can save up to ${max} template${max === 1 ? "" : "s"}. Delete one to save another.`,
    templatesLimitTitle: "Template limit reached",
    confirm: "Confirm", cancel: "Cancel", dismiss: "OK", confirmReplace: "Replace",
    ...
    templateLoadFailed: "Couldn't load that template.",
    templateSaveFailed: "Couldn't save the template.",
    ...
    fieldTypeImage: "Image", fieldTypeButton: "Button",
    ...
    buttonText: "Button text", buttonActionTitle: "Action", buttonAction: "When clicked",
    actionLink: "Open link", actionSubmit: "Submit", openIn: "Open in",
    sameTab: "Same tab", newTab: "New tab", submitScope: "Submits",
    thisSection: "This section", wholeForm: "Whole form", buttonSize: "Size",
  ...
  ja: {
    ...
    copyTemplate: "テンプレートをコピー", pasteTemplate: "テンプレートを貼り付け",
    copyTemplateTitle: "このフォームをテンプレートとしてコピーし、他のビルダーに貼り付けます",
    pasteTemplateTitle: "コピーしたテンプレートでこのフォームを置き換えます",
    pasteTemplateConfirm: "現在のフォームをコピーしたテンプレートで置き換えますか？この操作は取り消せません。",
    noTemplates: "まだテンプレートがありません。ツールバーの「保存」をクリックしてください。",
    noTemplatesReadonly: "利用できるテンプレートがまだありません。",
    updated: "更新日時", open: "開く", applyTemplate: "適用", saveForm: "テンプレートとして保存", formName: "テンプレート名",
    saveToLibrary: "テンプレートを保存", loadingDraft: "下書きを読み込んでいます...",
    templatesLimitReached: (max: number) => `テンプレートは${max}件まで保存できます。1件削除してから保存してください。`,
    templatesLimitTitle: "テンプレートの上限に達しました",
    confirm: "確定", cancel: "キャンセル", dismiss: "OK", confirmReplace: "置き換える",
    current: "現在編集中", customColor: "カスタムカラー",
    templateLabel: (name: string) => `テンプレート: ${name}`,
    templateEdited: "編集済み",
    templateLoading: "テンプレートを読み込み中...",
    templateLoadFailed: "テンプレートを読み込めませんでした。",
    ...
    fieldTypeImage: "画像", fieldTypeButton: "ボタン",
    ...
    buttonText: "ボタンのテキスト", buttonActionTitle: "アクション", buttonAction: "クリック時の動作",
    actionLink: "リンクを開く", actionSubmit: "送信", openIn: "開き方",
    sameTab: "同じタブ", newTab: "新しいタブ", submitScope: "送信範囲",
    thisSection: "このセクション", wholeForm: "フォーム全体", buttonSize: "サイズ",
