...
import type { SubmitStyle, Theme } from "../types";
...
export function DesignPanel({ chrome, theme, submitStyle, updateThemeColor, updateThemeLayout, onSubmitStyleChange, resetTheme }: DesignPanelProps) {
  return (
    <div>
