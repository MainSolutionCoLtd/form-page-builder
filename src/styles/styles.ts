...
export const styles: Record<string, CSSProperties> = {
  ...
  modal: { background: "var(--fb-surface)", borderRadius: 12, width: 520, maxHeight: "70vh", display: "flex", flexDirection: "column", overflow: "hidden", boxShadow: "0 20px 60px rgba(0,0,0,0.25)" },
